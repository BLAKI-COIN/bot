...
API_TOKEN = '7830092491:AAFKUYTJvikHD6q-kFYcv_xu1x76lwr7NMY'
ADMIN_ID = 7075997173  # Замените на свой Telegram ID
...
async def start_cmd(message: types.Message):
    ...
    conn.commit()
    keyboard = InlineKeyboardMarkup().add(InlineKeyboardButton("💰 Баланс", callback_data="balance"))
    await message.answer("Добро пожаловать в BLAKI Bot!", reply_markup=keyboard)
...
async def coinflip(message: types.Message):
    ...
    # Заглушка: эмуляция подброса монетки
